module nnlunar {
    export class Landscape {
        ...
        render(c: CanvasRenderingContext2D, view: View) {
            var offset = 0;
        ...
        checkLanderscapeCollision(lander: Lander): boolean {
            var lines = this.lines
                , right = lander.right % this.tileWidth
                , left = lander.left % this.tileWidth;
            while (right < 0) {
        ...
        pointIsLessThanLine(point: Vector2, linepoint1: Vector2, linepoint2: Vector2) {
    ...
    class LandingZone {
        ...
        constructor(lineNum: number, multi: number) {
    ...
    class InfoBox {
        ...
        constructor(align: number, width: number) {
            this.align = align;
            this.width = width;
        }
